<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li>
                <?php echo $this->Html->link($topic['Forum']['name'],array('controller'=>'topics','action'=>'index',$topic['Forum']['id']))?>
            </li>
            <li class="active">
    ...
    <div class="col-lg-12">
        ...
        <div class="well">
            ...
            <?php echo $this->Form->create('Post',array('url'=>array('controller'=>'posts','action'=>'add'),
                ...
                <?php echo $this->Form->hidden('forum_id',array('value'=>$topic['Forum']['id']));?>
